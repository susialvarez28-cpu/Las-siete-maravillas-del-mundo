  ...
  try {
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        Debes responder las preguntas concisas y solo lo que te pregunten, sin dar informacion adicional. 
        ...
        Ofrece información sobre el destino, clima, cultura, seguridad y recomendaciones gastronómicas.
        Analiza las necesidades y presupuesto del cliente para diseñar el viaje ideal.
